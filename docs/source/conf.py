...
# -*- coding: utf-8 -*-
#
# pgljupyter documentation build configuration file
#
...
_version_py = os.path.join(repo, 'pgljupyter', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'pgljupyterdoc'
...
latex_documents = [
    (master_doc, 'pgljupyter.tex', 'pgljupyter Documentation',
     'Jan Vaillant', 'manual'),
]
