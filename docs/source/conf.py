...
# -*- coding: utf-8 -*-
#
# plantgl-jupyter documentation build configuration file
#
...
copyright = '{% now 'local', '%Y' %}, Jan Vaillant'
author = 'Jan Vaillant'
...
_version_py = os.path.join(repo, 'plantgl-jupyter', '_version.py')
version_ns = {}
